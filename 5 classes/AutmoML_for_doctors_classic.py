...
with st.sidebar: 
    ...
    choice: str | None = st.radio('Navigation', ['Upload an Image', 'Result Analysis', 'Download our AI Trained Model', 'Feedback and Suggestions'])
...
DownloadModelPath: str = 'models/Tumor16.Jun.2024.14.20.33.825138_15epochs.h5'
ModelPath: str = r'Models'
modelname: str = r'C:\Users\shatn\Downloads\ICTD_Trained_Model.h5' # path of Intracranial Tumor Detector # if u switch from 'ICTD_Trained_Model.h5' to any other model then switch line 92 and 94
modelname_glioma: str = r'Glioma_17.Jun.2024.10.44.42.828487_512epochs.h5' # path of Glioma Model
modelname_pituitary: str = r'Pituitary16.Jun.2024.14.08.07.528789_15epochs.h5' # path of Pituitary Model
modelname_meningioma: str = r'Meningioma_16.Jun.2024.13.55.00.328927_15epochs.h5' # path of Meningioma Model
...
def TumorType(preprocessed_image) -> None:
    if modelname_meningioma is not None and modelname_pituitary is not None and modelname_pituitary is not None:
        ...
        if prediction_meningioma < 0.5 and prediction_pituitary < 0.5 and prediction_glioma < 0.5:
            ...
            st.error(f'Predicted class: Brain Tumor ({TumorType}).')
...
if choice == 'Download our AI Trained Model':
    ...
    with open(DownloadModelPath, 'rb') as f:
